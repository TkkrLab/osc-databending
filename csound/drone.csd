<CsoundSynthesizer>
  ...
  #define DEST  #"/drone/in/distortfactor"#
  #define DEST1 #"/drone/in/feedback"#
  #define DEST2 #"/drone/in/harmonic"#
  #define DEST3 #"/drone/in/disttable"#
  ...
  gilisten         OSCinit       7000
                   ...
                   instr         11
                   OSCsend       1, $OSCSERVER, 10000, "/drone/out/inputs", "s", "distortfactor,feedback,harmonic,disttable"
                   endin
  ...
  next1:
  kans1            OSClisten     gilisten, $DEST, "f", kdistortfactor
  ...
  kharmonic        init          0
  next3:
  kans3            OSClisten     gilisten, $DEST2, "f", kharmonic
                   if (kans3 == 0) goto done3
  kharmonic        =             2.0 * kharmonic             
  ;                 printks      "kharmonic = %f\\n", 0, kharmonic
  ...
  kdisttable       init          0
  next4:
  kans4            OSClisten     gilisten, $DEST3, "f", kdisttable
                   if (kans4 == 0) goto done4
  kdisttable       =             10.0 * kdisttable             
  ...
  kfeedback        init          0
  next2:
  kans2            OSClisten     gilisten, $DEST1, "f", kfeedback
