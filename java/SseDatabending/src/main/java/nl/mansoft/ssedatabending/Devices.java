    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sseOSCTask != null)
        {
            ...
            try {
                ...
                Document doc = typeParameter != null && typeParameter.equals("output") ? sseOSCTask.getOutputDevicesXML() : sseOSCTask.getInputDevicesXML();
                out.println(XMLUtils.documentToString(doc));
            } finally {
                out.close();
            }
        }
